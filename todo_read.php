...
// データ取得SQL作成
$sql = "SELECT * FROM todo_table2 LEFT OUTER JOIN (SELECT todo_id, COUNT(id) AS cnt FROM like_table GROUP BY todo_id) AS likes ON todo_table2.id = likes.todo_id";
...
if ($status == false) {
  ...
  foreach ($result as $record) {
    ...
    // 画像出力を追加しよう
    $output .= "<td><img src='{$record['image']}' style='height:100px;'></td>";
    $output .= "</tr>";
  }
